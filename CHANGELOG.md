...
- Replace browser translator language-code inputs with complete, readable
  native-name selectors and remove their VitePress layout offset.
...
- Recommend DeepSeek V4 Flash for OpenRouter translation and GPT-5.6 Luna for
  direct OpenAI translation.
- Document real translation costs with privacy-redacted terminal captures.
