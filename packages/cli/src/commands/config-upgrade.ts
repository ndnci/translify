...
const NESTED_SNIPPETS: Array<{ path: string[]; key: string; snippet: string }> = [
  ...
  { path: ['routing'], key: 'locales', snippet: 'locales: []' },
  { path: ['routing'], key: 'locale_prefix', snippet: "locale_prefix: 'as-needed'" },
  { path: ['routing'], key: 'locale_detection', snippet: 'locale_detection: true' },
  {
    path: ['routing'],
    key: 'locale_cookie',
    snippet: `locale_cookie: {
  name: 'translify_locale',
  max_age: 31536000,
  same_site: 'lax',
  secure: false,
